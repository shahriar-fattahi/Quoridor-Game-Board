...
Quoridor = tk.Tk()
Quoridor.geometry('570x620+300+0')
...
for i in range(9) :
    for j in range(9) :
        ...
        Square[f'sq{i}{j}'].place(height = 40 , width = 40 , y = (i+1)*20 + 40*i + 5 , x = (j+1) * 20 + j*40 + 5)
...
for i in range(10):
    for j in range(9) :
        if i == 0 or i == 9 :
            ...
            #Horizental_wall[f'wall{i}{j}'].place(height = 20 , width = 60 , x = j * 40 +(j+1)*20 + 5, y = i*40 + i * 20 +5)
            
        else :
            Horizental_wall[f'wall{i}{j}'] = tk.Button(Quoridor , background = "#aee2ff" , bd= 0)
        
        Horizental_wall[f'wall{i}{j}'].place(height = 20 , width = 60 , x = j * 40 +(j+1)*20 + 5, y = i*40 + i * 20 +5)
Horizental_wall['wall00'].place(height = 20 , width = 80 , x = 5, y = 5)
...
for i in range(9) :
    for j in range(10) :
        ...
        if i == 8 :
            Vertical_wall[f'wall{i}{j}'].place(height = 40 , width = 20 , x = j * 40 + (j)*20 + 5, y = i*40+(i+1)*20 + 5)
        else :
            Vertical_wall[f'wall{i}{j}'].place(height = 60 , width = 20 , x = j * 40 + (j)*20 + 5, y = i*40+(i+1)*20 + 5)
Vertical_wall['wall80'].place(height = 60 , width = 20 , x = 0 * 40 + (0)*20 + 5, y = 8*40+(8+1)*20 + 5)
...
player1.place(height = 30 , width = 30 , x = 270 , y = 30)
player2.place(height = 30 , width = 30, x = 270 , y = 510 )
        ...
        if Maze.step % 2 == 0 :
            if arg1['bg'] == "#aee2ff" and arg2['bg'] == "#aee2ff" and Maze.number_of_p1_wall != 0 :
                ...
                if is_valid_wall(x,y,typew) : 
                    ...
                    if typew == 'h' :
                        if Vertical_wall[f'wall{y-1}{x+1}']['bg'] == "#aee2ff" or Vertical_wall[f'wall{y}{x+1}']['bg'] == "#aee2ff":
                            arg1['bg'] = "#e8002a" #red
                            arg2['bg'] = "#e8002a"
                            Horizental_wall[f'wall{y}{x}'].lift()
                            Horizental_wall[f'wall{y}{x+1}'].lift()
                            Horizental_wall[f'wall{y}{x+1}'].place(height = 20 , width = 40 , x = (x+1) * 40 +(x+2)*20 + 5, y = (y)*40 + (y) * 20 +5) 
                            Maze.step += 1
                        ...
                        if Horizental_wall[f'wall{y+1}{x-1}']['bg'] == "#aee2ff" or Horizental_wall[f'wall{y+1}{x}']['bg'] == "#aee2ff":
                            arg1['bg'] = "#e8002a" #red
                            arg2['bg'] = "#e8002a"
                            Vertical_wall[f'wall{y}{x}'].lift()
                            Vertical_wall[f'wall{y+1}{x}'].lift()
                            Vertical_wall[f'wall{y+1}{x}'].place(height = 40 , width = 20 , x = x * 40 + (x)*20 + 5, y = (y+1)*40+(y+2)*20 + 5)
                            assign_wall_to_block()
                            Maze.step += 1
                            Maze.number_of_p1_wall -= 1
                            lbl_nwallp1['text'] = f'Player1 Walls : {Maze.number_of_p1_wall}'
...
def move(arg , y , x) :
    ...
    if arg['bg'] == "#ffff79" :
        ...
        if Maze.step % 2 == 0 :
            ...
            player1.place(x = (gx+1)*20 + gx*40 + 10 , y = (gy+1)*20 + gy*40 + 10)
            clear_square_color()
            Maze.step += 1
            lbl_turns['bg'] = "#00d021"
            lbl_turns['text'] = "Green Turn"
        ...
        ######################################################### p2
            ...
            player2.place(x = (gx+1)*20 + gx*40 + 10 , y = (gy+1)*20 + gy*40 + 10)
            clear_square_color()
            Maze.step += 1
            lbl_turns['bg'] = "#e8002a"
            lbl_turns['text'] = "Red Turn"
