...
#test_wall = tk.Button(Quoridor , text = "test wall")
#test_wall.place(height = 50 , width = 50 , x = 20 , y = 600)
#test_wall.config(command = assign_wall_to_block())
